...
/**
 * The public homepage's hero/how-it-works/features/CTA body, shared between
 * the logged-out marketing page (app/page.tsx) and the logged-in equivalent
 * (app/(app)/home/page.tsx, reached via the logo in the app header) — same
 * look either way, just with a different header/nav wrapped around it.
 */
